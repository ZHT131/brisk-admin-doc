...
import { Ref, InjectionKey, ComputedRef, defineComponent, ToRefs } from 'vue-demi';
...
declare type EventBusIdentifer<T = unknown> = EventBusKey<T> | string | number;
...
declare function useEventBus<T = unknown>(key: EventBusIdentifer<T>): UseEventBusReturn<T>;
