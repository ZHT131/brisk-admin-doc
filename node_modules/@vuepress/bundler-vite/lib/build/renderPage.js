...
const renderPage = async ({ app, page, vueApp, vueRouter, ssrTemplate, output, outputEntryChunk, outputCssAsset, }) => {
    ...
    // resolve page chunks
    const pageChunkFiles = resolvePageChunkFiles_1.resolvePageChunkFiles({ page, output });
    ...
    const html = ssrTemplate
        ...
        // page styles
        .replace('<!--vuepress-ssr-styles-->', renderPageStyles_1.renderPageStyles({ app, outputCssAsset }))
        .replace('<!--vuepress-ssr-app-->', pageRendered)
        // page scripts
        .replace('<!--vuepress-ssr-scripts-->', renderPageScripts_1.renderPageScripts({ app, outputEntryChunk }));
    // write html file
