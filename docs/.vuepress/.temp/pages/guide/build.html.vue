...
<p>框架已经内置了serve服务器环境插件，发布之前可以在本地进行预览</p>
<p><strong>不能直接打开构建后的 html 文件</strong></p>
<ul>
<li>使用项目自定的命令进行预览(推荐)</li>
</ul>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token comment"># 直接预览本地 dist 文件目录</span>
serve -s dist
</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h2 id="部署" tabindex="-1"><a class="header-anchor" href="#部署" aria-hidden="true">#</a> 部署</h2>
